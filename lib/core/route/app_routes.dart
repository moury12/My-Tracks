...
class AppRoutes {
  static route() => [
        ...
        GetPage(name: OTPScreen.routeName, page: () => const OTPScreen(),binding: AuthBinding()),
        GetPage(name: NewPasswordScreen.routeName, page: () => const NewPasswordScreen(),binding: AuthBinding()),
        GetPage(name: PrivacyTermsScreen.routeName, page: () => const PrivacyTermsScreen()),
        GetPage(name: ChangePasswordScreen.routeName, page: () => const ChangePasswordScreen()),
      ];
}
