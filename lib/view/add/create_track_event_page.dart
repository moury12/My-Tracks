              ...
              children: [
                    ...
                    : Obx(() {
                        return CustomDropdown<String>(
                          ...
                          items: CreateEventController.to.catList.isNotEmpty
                              ? CreateEventController.to.catList
                                  .map(
                              ...
                              : [],
                          onChanged: (value) {
                            CreateTrackController.to.selectedCategory.value =
                                value.toString();
                          },
                        );
                      }),
                ...
                Obx(() {
                  return UploadImageWidget(
                      ...
                      images:
                          CreateTrackController.to.trackPhotosList.isNotEmpty
                              ? Wrap(
                                  children: [
                                    ...List.generate(
                ...
                CustomTextField(
                  ...
                  onChanged: (value) async {
                    await searchLocation(value,
                        destinationLng: CreateTrackController.to.destinationLng,
                        destinationLat: CreateTrackController.to.destinationLat,
                        locationSuggestions:
                            CreateTrackController.to.locationSuggestions);
                  },
                ),
                Obx(() {
                  return CreateTrackController.to.locationSuggestions.isEmpty
                      ...
                      : ListView.builder(
                          shrinkWrap: true,
                          itemCount: CreateTrackController
                              .to.locationSuggestions.length,
                          itemBuilder: (context, index) {
                            final suggestion = CreateTrackController
                                .to.locationSuggestions[index];
                            return ListTile(
                              title: Text(
                                  suggestion.address), // Display the address
                              onTap: () {
                                debugPrint(
                                    '------------------------lat long---------------------');
                                // Handle the selection of a suggestion
                                CreateTrackController.to.destinationLat.value =
                                    suggestion.lat.toString();
                                CreateTrackController.to.destinationLng.value =
                                    suggestion.lng.toString();
                                debugPrint(
                                    'Selected Lat: ${CreateTrackController.to.destinationLat.value} Selected lng: ${CreateTrackController.to.destinationLng.value}');
                              },
                            );
                          },
                        );
                ...
                Obx(() {
                  return CustomButton(
                    isLoading:
                        CreateTrackController.to.isLoadingPostTrack.value,
                    onTap: () {
