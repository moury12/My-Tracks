                ...
                CustomTextField(
                  ...
                  onChanged: (value) async {
                    await searchLocation(value,
                        destinationLng:
                            CreateTrackEventController.to.destinationLng,
                        destinationLat:
                            CreateTrackEventController.to.destinationLat,
                        locationSuggestions:
                            CreateTrackEventController.to.locationSuggestions);
                  },
                ),
                Obx(() {
                  return CreateTrackEventController
                          .to.locationSuggestions.isEmpty
                      ? const SizedBox.shrink()
                      : ListView.builder(
                          shrinkWrap: true,
                          itemCount: CreateTrackEventController
                              .to.locationSuggestions.length,
                          itemBuilder: (context, index) {
                            final suggestion = CreateTrackEventController
                            ...
                            return ListTile(
                              ...
                              onTap: () {
                                ...
                                CreateTrackEventController.to.destinationLat
                                    .value = suggestion.lat.toString();
                                CreateTrackEventController.to.destinationLng
                                    .value = suggestion.lng.toString();
                                debugPrint(
                                    'Selected Lat: ${CreateTrackEventController.to.destinationLat.value} Selected lng: ${CreateTrackEventController.to.destinationLng.value}');
                              },
                            );
                          },
                        );
