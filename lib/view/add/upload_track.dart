        ...
        child: Column(spacing: 16.h,
          ...
          children: [
                  ...
                  children: [
                    ...
                    ...List.generate(
                      CreateTrackController.to.weekDays.length,
                          (index) => CreateTrackController.to.selectedDay.value == index
            ...
            ///===================dynamic available slot===================//
             Text('${AppStaticString.availableSlot} 10',style: poppinsMedium.copyWith(fontSize: getFontSizeLarge(context)),),
