...
class BookingManagementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    BookingManagementController.to.tabContent.add(
      Column(children: List.generate(5, (index) =>  Padding(
        padding: padding12V,
        child:  MarronGradientContainerWidget(
          child:BookingManagementController.to.selectedLabel.value==1?const TrackEventInfoContentWidget(): const HistoryContentWidget(),
        ),
      ),),)
    ); BookingManagementController.to.tabContent.add(
      Column(children: List.generate(5, (index) =>  Padding(
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
            ...
            children: [
              ...
              ...List.generate(
                BookingManagementController.to.tabs.length,
                    (index) => BookingManagementController.to.selectedLabel.value == index
                    ? Expanded(flex: 2,
                  child: GradientContainerWidget(
                    ...
                    ? space16W
                    : Expanded(flex: 2,
                    child: BlackContainerWidget(padding:padding12 ,
                      radius: 4.r,
                      onTap: () {
                        BookingManagementController.to.selectedLabel.value =
                            index;
                      },
                      text: BookingManagementController.to.tabs[index],
                    )),
        ...
        DynamicTabWidget(tabs: BookingManagementController.to.labelTabs, tabContent:BookingManagementController.to.tabContent )],),
      ),
    );
  }
}
